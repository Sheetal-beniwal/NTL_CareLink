        ...
        <div className="flex items-center gap-4">
          <div className="hidden lg:flex items-center gap-4 mr-4 border-r border-gray-200 pr-4">
            <div className="flex flex-col items-end">
              ...
              <span className="text-sm font-bold text-medical-dark">+91 81466 54185</span>
            </div>
          ...
          <button className="px-6 py-2.5 bg-medical-dark text-white rounded-full font-semibold hover:bg-medical-primary transition-all shadow-lg hover:shadow-medical-primary/20 active:scale-95 flex items-center gap-2">
